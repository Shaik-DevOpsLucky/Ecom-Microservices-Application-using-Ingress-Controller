...
## Deployment of Ecommerce-Microservices Application using Ingress Controller

**Created by: Shaik Moulali**
...
```bash
git remote set-url origin https://<your_username>:<your_token>@github.com/Shaik-DevOpsLucky/Ecom-Microservices-Application-using-Ingress-Controller.git
```
...
**GitHub Repository:**  
[https://github.com/Shaik-DevOpsLucky/Ecom-Microservices-Application-using-Ingress-Controller]
(https://github.com/Shaik-DevOpsLucky/Ecom-Microservices-Application-using-Ingress-Controller)
...
**Infrastructure:**
- AWS EKS Cluster (2 Worker Nodes, t2.small)
...
**LinkedIn:**
[https://www.linkedin.com/in/shaik-moulali-517b35278]
(https://www.linkedin.com/in/shaik-moulali-517b35278)
